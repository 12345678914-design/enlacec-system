  ...
  return (
    <div className={`min-h-screen ${cl.appBg} text-gray-950 dark:text-zinc-50 transition-colors duration-300 relative overflow-x-hidden font-sans pb-24`}>
      ...
      <section id="simulador-matricula" className="max-w-6xl mx-auto px-6 py-12 relative z-10 scroll-mt-24">
        ...
        <div className="bg-gradient-to-tr from-indigo-900/90 to-purple-950/90 border border-indigo-700/40 rounded-[32px] p-6 md:p-10 shadow-2xl relative overflow-hidden">
      ...
      {/* FOOTER */}
      <footer className="mt-8 border-t border-gray-250/30 dark:border-zinc-900/40 pt-8 text-center max-w-6xl mx-auto px-6 select-none relative z-10">
